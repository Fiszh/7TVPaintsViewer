...
As of this publication, 7TV developers allow the use of GQL for cosmetics. Please check [7TV API Documentation](https://api.unii.dev/seventv) for any updates or changes.
